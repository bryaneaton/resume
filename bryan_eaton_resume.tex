...
\section{Programming Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Data Engineering \& ETL}{: Databricks, Apache Airflow, Apache ActiveMQ, Apache Kafka, RabbitMQ, Pandas, Celery, PySpark}
    }
    \item{
    ...
    \item{
        \textbf{Cloud \& DevOps}{: Azure, Google Cloud (GCP), Amazon Web Services (AWS), Docker, Kubernetes, Vagrant}
    }
    \item{
