...
\section{Experience}
  \resumeSubHeadingListStart
	...
	{A principal developer for the RegScale CLI. Designed and implemented core features of the RegScale CLI, a data integration tool, integrating with 40+ CyberSecurity related services and tools.}
	\resumeItem{C# Development}
	{Implemented REST services as well as document services for generating OSCAL compliant XML, and various FedRAMP formats for the RegScale platform. }
	\resumeItemListEnd
    \resumeSubheading
...
rectification and temporal/3D animation.}
        \resumeItem{Python ArcPy and ArcObjects}
         ...
         {Wrote SQL queries, customized stored procedures and assisted in creation of a .NET/SQL database
front-end for the Houston-Galveston Subsidence District’s 70-year population and water demand projections.}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Python, Java, R, Javascript, C$\sharp$, SQL}
      \hfill
